...
export class ManagementCashierAPI {
    private readonly url: string = '/cashier';

    async getList(
        params: ManagementCashier.Request.List
    ...
    async getDetailQueue(): Promise<ManagementCashier.Response.DetailListQueue> {
    ...
    async payment(
        body: ManagementCashier.Request.Payment
    ): Promise<ManagementCashier.Response.Payment> {
